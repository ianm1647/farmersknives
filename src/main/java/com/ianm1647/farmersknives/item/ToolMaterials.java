...
public enum ToolMaterials implements ToolMaterial {
    ...
    VIBRANIUM(4, 2990, 17.0F, 6.0F, 12,
            () -> Ingredient.ofItems(Registry.ITEM.get(new Identifier("adabraniummod", "vibranium_ingot")))),
    ADAMANTIUM(4, 4280, 25.0F, 9.0F, 10,
            () -> Ingredient.ofItems(Registry.ITEM.get(new Identifier("adabraniummod", "adamantium_ingot")))),
